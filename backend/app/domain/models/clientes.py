...
class Clientes(Base):
    ...
    obra_social: Mapped[str | None] = mapped_column(String(200), nullable=True)
    ...
    __table_args__ = (
        CheckConstraint("tipo_cliente IN ('fisica', 'juridica')", name="chk_tipo_cliente"),
    )
