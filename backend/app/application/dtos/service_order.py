...
class CreateOrderRequest(BaseModel):
    ...
    requested_by: Optional[str] = Field(None, max_length=255, description="Who requested the service")
    department: Optional[str] = Field(None, max_length=255, description="Requester department")
    visit_type: Optional[str] = Field(None, max_length=20, description="Visit type: normal/contract/warranty")
    equipment_condition: Optional[str] = Field(None, max_length=20, description="Equipment condition: new/used/other")
    declared_fault: Optional[str] = Field(None, description="Fault declared by client")
    accessories: Optional[str] = Field(None, description="Accessories present with equipment")
    work_hours: Optional[int] = Field(None, ge=0, description="Hours of work")
    operators_count: Optional[int] = Field(None, ge=0, description="Number of operators")
    kilometers: Optional[Decimal] = Field(None, ge=0, description="Kilometers traveled")
    travel_expenses: Optional[Decimal] = Field(None, ge=0, description="Travel expenses")
...
class OrderResponse(BaseModel):
    ...
    service_date: Optional[date] = Field(None, description="Scheduled service date")
    next_service_date: Optional[date] = Field(None, description="Next service date")
    requested_by: Optional[str] = Field(None, description="Who requested the service")
    department: Optional[str] = Field(None, description="Requester department")
    visit_type: Optional[str] = Field(None, description="Visit type: normal/contract/warranty")
    equipment_condition: Optional[str] = Field(None, description="Equipment condition: new/used/other")
    declared_fault: Optional[str] = Field(None, description="Fault declared by client")
    accessories: Optional[str] = Field(None, description="Accessories present with equipment")
    work_hours: Optional[int] = Field(None, description="Hours of work")
    operators_count: Optional[int] = Field(None, description="Number of operators")
    kilometers: Optional[Decimal] = Field(None, description="Kilometers traveled")
    travel_expenses: Optional[Decimal] = Field(None, description="Travel expenses")
